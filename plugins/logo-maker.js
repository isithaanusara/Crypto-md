...
cmd({
  ...
  try {
    ...
    let responseText = `*🤍 CRYPTO-MD LOGO MAKER 💫*\n\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n`
    + `*◈ Text:* ${q}\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n\n`
    ...
    conn.ev.on('messages.upsert', async (event) => {
      ...
      if (receivedMessage.message.extendedTextMessage.contextInfo && 
        ...
        if (logoUrls[receivedText]) {
          ...
          await conn.sendMessage(from, { image: { url: response.result.download_url }, caption: "> *© Powered By 𝐂𝐑𝐘𝐏𝐓𝐎 𝐊𝐍𝐈𝐆𝐇𝐓*" }, { quoted });
        } else {
