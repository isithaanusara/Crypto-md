...
// SEND DOC TYPE
await conn.sendMessage(from, { document: { url: ytdl.download.url }, mimetype: "audio/mpeg", fileName: ytdl.result.title + '.mp3', caption: `> *© Pᴏᴡᴇʀᴇᴅ Bʏ 𝐂𝐑𝐘𝐏𝐓𝐎 𝐊𝐍𝐈𝐆𝐇𝐓♡*` }, { quoted: mek })
